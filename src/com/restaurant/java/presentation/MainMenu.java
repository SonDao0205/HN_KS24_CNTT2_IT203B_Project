...
public class MainMenu {
    public static void printMenu(Scanner sc, IUserServiceImpl userService) {
        int choice;
        do {
            System.out.println("""
                    +---------------------------------------+
            ...
            switch (choice) {
                case 1 -> AuthenticationMenu.printLoginMenu(sc,userService);
                case 2 -> AuthenticationMenu.printRegisterMenu(sc,userService);
